<h1 align="center">Hi , I'm Mohit Sahay</h1>
<p align="center"> 
...
<h3 align="center"> A passionate and solution-driven DevOps Engineer, I build the pipelines, infrastructure, and automation that help engineering teams ship faster and sleep better at night.
With 2.5+ years of hands-on DevOps experience at HCLTech, I work at the intersection of cloud infrastructure and application delivery, managing CI/CD pipelines, containerized workloads on Azure Kubernetes Service, and compliance-ready deployments for a global client.

 What I do day-to-day:
- Design and manage Azure DevOps pipelines that reduce manual effort and enforce deployment standards
- Manage Kubernetes (AKS) workloads, deployments, scaling, rollbacks, and troubleshooting
- Implement Infrastructure as Code using Azure Bicep and Terraform
- Bridge the gap between application and infrastructure teams, turning blockers into shipped solutions
- Monitor production systems via Azure Monitor & Grafana, keeping downtime low
- Drive GitOps workflows with ArgoCD and Helm for drift detection and automated sync

Core Stack:
Azure DevOps · Kubernetes · Docker · Helm · ArgoCD · GitHub Actions · Terraform · Azure Bicep · Grafana · Linux · Azure Logic Apps · Service Bus
</h3>
